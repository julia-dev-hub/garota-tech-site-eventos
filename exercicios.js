...
Obs.: Importar esse arquivo no index.html
...
- Imprima o objeto evento no console.
- Imprima o valor da propriedade data do objeto evento no console.
- Altere o valor da propriedade data do objeto evento para "20/07/2024".
- Exiba o objeto no console novamente.
- Crie um array chamado "listaDeEventos" que contém 3 objetos, cada um representando um evento diferente.
- Imprima o primeiro item da lista de eventos no console.


Exercício 4 - Eventos:

- Crie uma função "confirmarPresenca" e adicione no método onclick do botão "Confirmar presença";
- Dentro dessa função, exiba um alert com a mensagem "Presença confirmada no evento: Festa de Aniversário".
